...
#define CONFIGURE_ARGS " '--prefix=/Users/tyrauber/Sites/react-native-pglite/vendor/postgres-pglite/build-ios-arm64/install' '--host=aarch64-apple-darwin' '--disable-largefile' '--without-llvm' '--without-pam' '--with-openssl=no' '--without-readline' '--without-icu' '--without-libxml' '--without-zlib' 'host_alias=aarch64-apple-darwin' 'CC=/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang -arch arm64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS26.0.sdk -miphoneos-version-min=13.0' 'CFLAGS=-fPIC -O2 -DHAVE_SPINLOCKS' 'LDFLAGS=-isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS26.0.sdk -fPIC' 'CPPFLAGS=-isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS26.0.sdk -DHAVE_SPINLOCKS -DPGL_MOBILE  -DPGL_EXT_CITEXT -DPGL_EXT_HSTORE -DPGL_EXT_LTREE -DPGL_EXT_PG_TRGM -DPGL_EXT_FUZZYSTRMATCH -DPGL_EXT_INTARRAY -DPGL_EXT_BLOOM -DPGL_EXT_CUBE -DPGL_EXT_SEG -DPGL_EXT_ISN -DPGL_EXT_LO -DPGL_EXT_TABLEFUNC -DPGL_EXT_UNACCENT -DPGL_EXT_BTREE_GIN -DPGL_EXT_BTREE_GIST -DPGL_EXT_TCN -DPGL_EXT_TSM_SYSTEM_ROWS -DPGL_EXT_TSM_SYSTEM_TIME -DPGL_EXT_DICT_INT -DPGL_EXT_DICT_XSYN -DPGL_EXT_PGROWLOCKS -DPGL_EXT_PGSTATTUPLE -DPGL_EXT_INTAGG -DPGL_EXT_REFINT -DPGL_EXT_AUTOINC -DPGL_EXT_INSERT_USERNAME -DPGL_EXT_MODDATETIME -D_FORTIFY_SOURCE=0' 'PKG_CONFIG_PATH=:/usr/local/opt/libffi/lib/pkgconfig:/usr/local/opt/libffi/lib/pkgconfig'"
